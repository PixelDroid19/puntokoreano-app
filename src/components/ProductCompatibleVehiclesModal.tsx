...
interface ProductCompatibleVehiclesModalProps {
  isOpen: boolean;
  onClose: () => void;
  productId: string;
  productName: string;
...
const ProductCompatibleVehiclesModal: React.FC<ProductCompatibleVehiclesModalProps> = ({
  isOpen,
  onClose,
  productId,
  productName,
  ...
  // Columnas para la tabla - exactamente iguales a compatible-vehicles-viewer
  const columns = [
    {
      title: "Marca",
    ...
    >
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex gap-2 items-center">
          <Input
            placeholder="Buscar por marca, modelo, año, transmisión, combustible, motor..."
            value={searchTerm}
...
export default ProductCompatibleVehiclesModal; 